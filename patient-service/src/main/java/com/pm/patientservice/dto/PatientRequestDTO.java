...
public class PatientRequestDTO {
    ...
    // we need for admin to enter regiser date when entering a new patient as opposed to requestdto mae we dont give registred date as client doesnt need one
